...
public class Login2 extends Frame implements ActionListener {
    ...
    public Login2() {
        ...
        setTitle("Friend2 Login");
        setSize(450, 600);
        setLayout(null);
        setBackground(new Color(240, 255, 240)); // light pink shade

        // Header banner
        Label title = new Label("🔒 Secret Chat - Friend2", Label.CENTER);
        title.setBounds(50, 80, 350, 40);
        title.setFont(new Font("Arial", Font.BOLD, 18));
        title.setForeground(Color.white);
        title.setBackground(new Color(37, 211, 102)); // Blue shade
        add(title);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == loginBtn) {
            ...
            if (user.equals("ruchi") && pass.equals("5678")) {
                msg.setText("✅ Login successful!");
                msg.setForeground(Color.green);
                dispose(); // close login window
                new Friend2(); // open chat window
            } else {
